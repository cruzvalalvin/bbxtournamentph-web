    ...
    <section className="relative py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16 px-2">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-neon-green mb-3 sm:mb-4">
            Feature Preview
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative bg-dark-card border border-dark-border rounded-xl p-5 sm:p-6 hover-lift hover:border-neon-green/50 transition-all duration-300"
            >
              {/* Icon */}
              ...
              {/* Title */}
              <h3 className="text-lg sm:text-xl font-bold text-neon-green mb-2 sm:mb-3 group-hover:text-glow transition-all duration-300">
                {feature.title}
              </h3>
